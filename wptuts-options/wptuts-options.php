...
/*
  ...
  Plugin URI: 
  Description: Theme options with upload
  Version: 1.0
  Author: ORO VIETNAM
  Author URI: 
  License: GPL2
...
function wptuts_options_enqueue_scripts() {
	wp_register_script( 'wptuts-upload', plugins_url() .'/wptuts-options/js/wptuts-upload.js', array('jquery','media-upload','thickbox') );	
